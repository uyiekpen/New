      ...
      <Column className="bg-gray_50 border-8 border-red_A700 border-solid font-roboto items-center justify-end mx-[auto] lg:pt-[20px] xl:pt-[23px] pt-[26px] 3xl:pt-[31px] w-[100%]">
                ...
                suffix={
                  <Image
                    ...
                    src={
                      inputvalue?.length
                        ? "images/close22.svg"
                        : "images/img_magnifyingglass_23.png"
                    }
        ...
        <Column className="items-start justify-start xl:mt-[10px] mt-[12px] 3xl:mt-[14px] lg:mt-[9px] w-[100%]">
          ...
          <Row className="items-center justify-start w-[95%]">
            <Column className="bg-gray_50 items-start outline outline-[0.5px] outline-blue_800 lg:pl-[62px] xl:pl-[71px] pl-[80px] 3xl:pl-[96px] lg:py-[62px] xl:py-[71px] py-[80px] 3xl:py-[96px] w-[18%]">
              <Row className="items-center justify-end lg:ml-[21px] xl:ml-[24px] ml-[27px] 3xl:ml-[32px] xl:mt-[1px] lg:mt-[1px] mt-[2px] w-[50%]">
                <Image
              ...
              <Input
                ...
                WrapClassName="3xl:mt-[34px] 3xl:pb-[24px] 3xl:pl-[27px] 3xl:pr-[39px] 3xl:pt-[21px] bg-blue_800 flex lg:mt-[22px] lg:pb-[15px] lg:pl-[17px] lg:pr-[25px] lg:pt-[14px] mt-[29px] pb-[20px] pl-[23px] pr-[33px] pt-[18px] rounded-bl-[20px] rounded-br-[0] rounded-tl-[20px] rounded-tr-[0] w-[100%] xl:mt-[25px] xl:pb-[17px] xl:pl-[20px] xl:pr-[29px] xl:pt-[16px]"
                name="Group439"
                placeholder="Interview"
                prefix={
                  <Image
                    src={"images/img_suitcasesimple_19.png"}
              ...
              ></Input>
              <Row className="items-center justify-end lg:mb-[474px] xl:mb-[542px] mb-[610px] 3xl:mb-[732px] lg:ml-[17px] xl:ml-[20px] ml-[23px] 3xl:ml-[27px] lg:mt-[17px] xl:mt-[20px] mt-[23px] 3xl:mt-[27px] w-[62%]">
                <Image
                  src={"images/img_gear_21.png"}
                  ...
                  <>
                    <Row className="items-end justify-start lg:mx-[15px] xl:mx-[17px] mx-[20px] 3xl:mx-[24px] outline outline-[0.5px] outline-blue_800 lg:p-[22px] xl:p-[25px] p-[29px] 3xl:p-[34px] rounded-radius20">
                      <Column className="items-center justify-start lg:ml-[14px] xl:ml-[16px] ml-[19px] 3xl:ml-[22px] lg:mt-[14px] xl:mt-[16px] mt-[19px] 3xl:mt-[22px] lg:pr-[34px] xl:pr-[39px] pr-[44px] 3xl:pr-[52px] w-[49%]">
                        <Image
                          src={"images/img_rectangle89_18.png"}
                ...
                <Stack className="lg:h-[242px] xl:h-[276px] h-[310px] 2xl:h-[311px] 3xl:h-[373px] w-[100%]">
                  <Column className="absolute h-[max-content] inset-[0] items-center justify-center m-[auto] w-[86%]">
                    <Row className="items-start justify-between w-[97%]">
                      <Image
                        src={"images/img_rectangle89_20.png"}
                      ...
                      <Column className="items-start justify-start lg:mb-[16px] xl:mb-[18px] mb-[21px] 3xl:mb-[25px] w-[44%]">
                        ...
                        <Text className="font-normal ml-[0] lg:mt-[13px] xl:mt-[15px] mt-[17px] 3xl:mt-[20px] not-italic lg:text-[18px] xl:text-[21px] text-[24px] 3xl:text-[28px] text-gray_900 w-[auto]">
                          Product designer
                        </Text>
                        <Input
                  ...
                  <Stack className="absolute lg:h-[242px] xl:h-[276px] h-[310px] 2xl:h-[311px] 3xl:h-[373px] outline outline-[0.5px] outline-blue_800 lg:p-[3px] xl:p-[4px] p-[5px] 3xl:p-[6px] rounded-radius20 w-[100%]">
                    <Image
                      src={"images/img_plus_22.png"}
                      className="absolute lg:h-[28px] xl:h-[33px] h-[36px] 2xl:h-[37px] 3xl:h-[44px] object-contain top-[0] w-[8%]"
                      alt="Plus"
                    />
                  </Stack>
                </Stack>
                <Stack className="lg:h-[236px] xl:h-[270px] h-[303px] 2xl:h-[304px] 3xl:h-[364px] lg:mb-[3px] xl:mb-[4px] mb-[5px] 3xl:mb-[6px] mt-[1px] lg:pr-[6px] xl:pr-[7px] pr-[8px] 3xl:pr-[9px] w-[100%]">
                  <Column className="absolute h-[max-content] inset-[0] items-start justify-center m-[auto] w-[91%]">
                    <Row className="items-start justify-between w-[100%]">
                      <Image
                        src={"images/img_rectangle89_21.png"}
