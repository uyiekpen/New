  ...
  return (
    <>
      <Column className="bg-gray_50 font-roboto items-center justify-end mx-[auto] lg:pt-[20px] xl:pt-[23px] pt-[26px] 3xl:pt-[31px] w-[100%]">
        <header className="w-[89%]">
          <Stack className="bg-white_A700 lg:h-[46px] xl:h-[53px] h-[59px] 2xl:h-[60px] 3xl:h-[71px] w-[100%]">
            ...
            <Row className="absolute h-[max-content] inset-y-[0] items-center justify-start my-[auto] xl:pr-[3px] lg:pr-[3px] pr-[4px] w-[40%]">
                ...
                suffix={
                  <Image
                    ...
                    src={
                      inputvalue?.length
                        ? "images/close24.svg"
                        : "images/img_magnifyingglass_25.png"
                    }
              ...
              <Image
                src={"images/img_ellipse18_4.png"}
        ...
        <Column className="items-center justify-end xl:mt-[10px] mt-[12px] 3xl:mt-[14px] lg:mt-[9px] w-[100%]">
          <Line className="bg-blue_800 h-[1440px] rotate-[-90deg] w-[100%]" />
          <Row className="items-start justify-between w-[100%]">
            <Column className="bg-gray_50 items-start justify-center lg:mb-[38px] xl:mb-[44px] mb-[50px] 3xl:mb-[60px] outline outline-[0.5px] outline-blue_800 lg:pl-[62px] xl:pl-[71px] pl-[80px] 3xl:pl-[96px] lg:py-[62px] xl:py-[71px] py-[80px] 3xl:py-[96px] rounded-bl-[40px] rounded-br-[0] rounded-tl-[0] rounded-tr-[0] w-[18%]">
              ...
              <Input
                ...
                prefix={
                  <Image
                    src={"images/img_suitcasesimple_21.png"}
            ...
            <Column className="items-start justify-start lg:mt-[51px] xl:mt-[58px] mt-[66px] 3xl:mt-[79px] w-[79%]">
              ...
              <Slider
                ...
                ref={sliderRef}
                className="lg:mt-[24px] xl:mt-[28px] mt-[32px] 3xl:mt-[38px] w-[93%]"
                items={[...Array(6)].map(() => (
                  <>
                    <Row className="items-end justify-start lg:mx-[15px] xl:mx-[17px] mx-[20px] 3xl:mx-[24px] outline outline-[0.5px] outline-blue_800 lg:p-[22px] xl:p-[25px] p-[29px] 3xl:p-[34px] rounded-radius20">
                      <Column className="items-center justify-start lg:ml-[14px] xl:ml-[16px] ml-[19px] 3xl:ml-[22px] lg:mt-[14px] xl:mt-[16px] mt-[19px] 3xl:mt-[22px] lg:pr-[34px] xl:pr-[39px] pr-[44px] 3xl:pr-[52px] w-[49%]">
                        <Image
                          src={"images/img_rectangle89_22.png"}
              ...
              />
              <Row className="items-start justify-evenly lg:mt-[5px] xl:mt-[6px] mt-[7px] 3xl:mt-[8px] w-[100%]">
                <Column className="items-start justify-start mb-[108px] 3xl:mb-[129px] lg:mb-[84px] xl:mb-[96px] lg:mt-[20px] xl:mt-[23px] mt-[26px] 3xl:mt-[31px] lg:pr-[33px] xl:pr-[38px] pr-[43px] 3xl:pr-[51px] w-[49%]">
                  <Text className="font-medium lg:text-[24px] xl:text-[28px] text-[32px] 3xl:text-[38px] text-gray_900 w-[auto]">
                    Schedule new interview
                  </Text>
                  <Stack className="lg:h-[242px] xl:h-[276px] h-[310px] 2xl:h-[311px] 3xl:h-[373px] lg:mt-[24px] xl:mt-[28px] mt-[32px] 3xl:mt-[38px] w-[100%]">
                    <Column className="absolute h-[max-content] inset-[0] items-center justify-center m-[auto] w-[86%]">
                      <Row className="items-start justify-between w-[97%]">
                        <Image
                          src={"images/img_rectangle89_24.png"}
                ...
                <Stack className="lg:h-[400px] xl:h-[458px] h-[514px] 2xl:h-[515px] 3xl:h-[618px] w-[51%]">
                  <Stack className="absolute lg:h-[236px] xl:h-[270px] h-[303px] 2xl:h-[304px] 3xl:h-[364px] inset-y-[0] my-[auto] lg:pr-[6px] xl:pr-[7px] pr-[8px] 3xl:pr-[9px] w-[88%]">
                    <Column className="absolute h-[max-content] inset-[0] items-start justify-center m-[auto] w-[91%]">
                      <Row className="items-start justify-between w-[100%]">
                        <Image
                          src={"images/img_rectangle89_25.png"}
                        ...
                        <Column className="items-start justify-start lg:mb-[15px] xl:mb-[17px] mb-[20px] 3xl:mb-[24px] w-[48%]">
                          ...
                          <Column className="bg-white_A700 items-start justify-start xl:mt-[10px] mt-[12px] 3xl:mt-[14px] lg:mt-[9px] lg:p-[4px] xl:p-[5px] p-[6px] 3xl:p-[7px] rounded-radius10 shadow-bs17 w-[83%]">
                            <Text className="font-normal xl:mb-[3px] lg:mb-[3px] mb-[4px] 3xl:ml-[10px] lg:ml-[7px] xl:ml-[8px] ml-[9px] not-italic lg:text-[18px] xl:text-[21px] text-[24px] 3xl:text-[28px] text-gray_900 w-[auto]">
                              22/04/2022
                            </Text>
                          </Column>
                        </Column>
                      ...
                      <Row className="items-end justify-start xl:ml-[1px] lg:ml-[1px] ml-[2px] lg:mt-[15px] xl:mt-[17px] mt-[20px] 3xl:mt-[24px] w-[94%]">
                        ...
                        ></SelectBox>
                        <Column className="bg-blue_800 items-center justify-start mb-[0] lg:ml-[38px] xl:ml-[44px] ml-[50px] 3xl:ml-[60px] lg:p-[12px] xl:p-[14px] p-[16px] 3xl:p-[19px] rounded-radius10 w-[46%]">
                          <Text className="font-bold lg:text-[18px] xl:text-[21px] text-[24px] 3xl:text-[28px] text-white_A700 w-[auto]">
                            Schedule
                          </Text>
                        </Column>
                      </Row>
                  ...
                  <Column
                    className="absolute bg-cover bg-repeat items-center justify-end lg:pl-[27px] xl:pl-[31px] pl-[35px] 3xl:pl-[42px] lg:py-[27px] xl:py-[31px] py-[35px] 3xl:py-[42px] rounded-radius40 shadow-bs21 w-[59%]"
                    style={{
                      backgroundImage: "url('images/img_frame120_1.png')",
                    }}
                  >
                    <Image
                      src={"images/img_image2_3.png"}
                      className="lg:h-[125px] xl:h-[143px] h-[160px] 2xl:h-[161px] 3xl:h-[193px] lg:mt-[10px] xl:mt-[12px] mt-[14px] 3xl:mt-[16px] object-contain rounded-radius50 w-[auto]"
                      alt="image2"
                    />
                    <Text className="font-bold lg:mt-[18px] xl:mt-[21px] mt-[24px] 3xl:mt-[28px] lg:text-[24px] xl:text-[28px] text-[32px] 3xl:text-[38px] text-gray_900 w-[auto]">
                      Daniel James
                    </Text>
                    <Text className="font-medium lg:mt-[6px] xl:mt-[7px] mt-[8px] 3xl:mt-[9px] lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-gray_900 w-[auto]">
                      Product designer
                    </Text>
                    <Text className="font-bold xl:mt-[3px] lg:mt-[3px] mt-[4px] lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-gray_900 w-[auto]">
                      4 Years Experience
                    </Text>
                    <Row className="items-center justify-end lg:mt-[18px] xl:mt-[21px] mt-[24px] 3xl:mt-[28px] w-[90%]">
                      <Button className="font-normal not-italic outline outline-[0.5px] outline-blue_800 lg:py-[6px] xl:py-[7px] py-[8px] 3xl:py-[9px] rounded-radius10 lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-center text-gray_900 w-[37%]">
                        Adobe XD
                      </Button>
                      <Button className="font-normal lg:ml-[6px] xl:ml-[7px] ml-[8px] 3xl:ml-[9px] not-italic outline outline-[0.5px] outline-blue_800 lg:py-[6px] xl:py-[7px] py-[8px] 3xl:py-[9px] rounded-radius10 lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-center text-gray_900 w-[28%]">
                        Figma
                      </Button>
                      <Button className="font-normal lg:ml-[6px] xl:ml-[7px] ml-[8px] 3xl:ml-[9px] not-italic outline outline-[0.5px] outline-blue_800 lg:py-[6px] xl:py-[7px] py-[8px] 3xl:py-[9px] rounded-radius10 lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-center text-gray_900 w-[29%]">
                        Sketch
                      </Button>
                    </Row>
                    <Button className="bg-blue_800 font-bold lg:mt-[37px] xl:mt-[42px] mt-[48px] 3xl:mt-[57px] lg:py-[12px] xl:py-[14px] py-[16px] 3xl:py-[19px] rounded-radius10 shadow-bs22 lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-center text-white_A700 w-[99%]">
                      View resume
                    </Button>
                  </Column>
                </Stack>
...
export default Landingpage2Page;
